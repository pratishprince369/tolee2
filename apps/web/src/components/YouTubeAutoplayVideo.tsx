        ...
        <div className="relative w-full h-full overflow-hidden select-none bg-black">
          ...
          <div className="absolute top-3 right-3 flex items-center gap-2 z-20 pointer-events-auto">
            <button
              type="button"
              onClick={toggleMute}
              className="w-9 h-9 rounded-full bg-black/90 hover:bg-black text-white backdrop-blur-md flex items-center justify-center border border-white/20 shadow-xl transition-all active:scale-95"
          ...
          {/* Solid Bottom Black Bar + TOLEE HD Watermark Mask (100% Covers YouTube Logo Zone) */}
          <div className="absolute bottom-0 left-0 right-0 h-14 bg-gradient-to-t from-black via-black/95 to-transparent pointer-events-none z-20 flex items-center justify-between px-4">
            <span className="text-[10px] text-zinc-400 font-medium tracking-wide truncate max-w-[60%]">
              Tolee HD Player
            </span>
