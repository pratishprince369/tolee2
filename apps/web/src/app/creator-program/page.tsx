          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {CREATOR_BENEFITS.map((b, i) => (
                <div key={i} className="benefit-card glass-card rounded-2xl p-6 transition-all duration-300 cursor-default relative overflow-hidden group" style={{ animationDelay: `${i * 0.1}s` }}>
