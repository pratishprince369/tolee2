...
export default function WorldDashboardClient() {
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm text-gray-400 mt-1 max-w-xl">
                Explore curated AI apps, digital libraries, and creator productivity tools published by Tolee.
              </p>
            </div>
          </div>
        ...
        {loading ? (
          ...
          <div className="py-16 text-center bg-[#0a101d] border border-[#142036] rounded-2xl p-8">
            ...
            <p className="text-xs text-gray-400 max-w-md mx-auto">
              Check back soon as new tools and features are frequently added to Tolee World!
            </p>
          </div>
        ) : (
